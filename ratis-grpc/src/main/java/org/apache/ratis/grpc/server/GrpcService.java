...
public final class GrpcService extends RaftServerRpcWithProxy<GrpcServerProtocolClient,
  ...
  private GrpcService(RaftServer server,
    ...
    this(server, server::getId,
        GrpcConfigKeys.Admin.host(server.getProperties()), GrpcConfigKeys.Admin.port(server.getProperties()), adminTlsConfig,
        GrpcConfigKeys.Client.host(server.getProperties()), GrpcConfigKeys.Client.port(server.getProperties()), clientTlsConfig,
        GrpcConfigKeys.Server.host(server.getProperties()), GrpcConfigKeys.Server.port(server.getProperties()), serverTlsConfig,
