...
public final class ServerImplUtils {
  ...
  public static RaftServerProxy newRaftServer(
      ...
      RaftProperties properties, Parameters parameters, Thread.UncaughtExceptionHandler exceptionHandler) throws IOException {
    ...
    final RaftServerProxy proxy = newRaftServer(id, stateMachineRegistry, properties, parameters, exceptionHandler);
  ...
  private static RaftServerProxy newRaftServer(
    ...
    try {
      ...
      proxy = JavaUtils.attemptRepeatedly(
          () -> new RaftServerProxy(id, stateMachineRegistry, properties, parameters, exceptionHandler),
