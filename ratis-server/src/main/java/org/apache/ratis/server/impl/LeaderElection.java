  ...
  private boolean askForVotes(Phase phase, int round) throws InterruptedException, IOException {
    ...
    synchronized (server) {
      ...
      switch (r.getResult()) {
        ...
        case NOT_IN_CONF:
        case SHUTDOWN:
          LOG.info("Expect this log because {} get {} msg and is closed.", server.getId(),
              r.getResult());
        ...
        case DISCOVERED_A_NEW_TERM:
          ...
          LOG.info("ratis-server/src/main/java/org/apache/ratis/server/impl/LeaderElection.java");
