...
/** An {@link OutputStream} implementation using {@link org.apache.ratis.client.api.AsyncApi#sendAsync(Message)} API. */
public class RaftOutputStream extends OutputStream {
  ...
  private void flushAsync() {
    ...
    final CompletableFuture<Long> f = getClient().getAsyncApi().sendAsync(
