...
public interface RaftClientConfigKeys {
  ...
  interface Rpc {
    ...
    TimeDuration WATCH_REQUEST_TIMEOUT_DURATION_DEFAULT =
        TimeDuration.valueOf(10000, TimeUnit.MILLISECONDS);
    static TimeDuration watchRequestTimeout(RaftProperties properties) {
      return getTimeDuration(properties.getTimeDuration(WATCH_REQUEST_TIMEOUT_DURATION_DEFAULT.getUnit()),
          WATCH_REQUEST_TIMEOUT_KEY, WATCH_REQUEST_TIMEOUT_DURATION_DEFAULT, getDefaultLog());
    }
